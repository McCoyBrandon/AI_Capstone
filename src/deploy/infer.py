...
Usage:
    python -m src.deploy.infer --ckpt runs/main_save/model.ckpt \
        --csv  src/data/ai4i2020.csv \
        --out  runs/main_save/infer_metrics.json \
        --failures-out runs/main_save/flagged_failures.csv
"""
...
parser.add_argument("--ckpt", type=str, default="runs/main_save/model.ckpt",
...
parser.add_argument("--out", type=str, default="runs/main_save/demo_metrics.json",
                    help="Where to save evaluation metrics JSON")
parser.add_argument("--failures-out", type=str, default="runs/main_save/flagged_failures.json",
                    help="Optional JSON list of test-set machines predicted to fail")
parser.add_argument("--failures-csv", type=str, default="runs/main_save/flagged_failures.csv",
